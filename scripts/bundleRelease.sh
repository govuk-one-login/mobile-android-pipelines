#!/usr/bin/env bash
# Example: `MODULES_TO_BUNDLE=app,modules/testWrapper INPUT_FLAVORS=staging,integration scripts/bundleRelease.sh`

# Converting comma separated string input into a list of strings for module paths.
