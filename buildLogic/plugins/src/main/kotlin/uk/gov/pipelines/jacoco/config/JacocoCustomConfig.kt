package uk.gov.pipelines.jacoco.config

import org.gradle.api.Project
import org.gradle.api.file.FileTree
import org.gradle.api.tasks.TaskProvider
import org.gradle.testing.jacoco.tasks.JacocoReport
import uk.gov.pipelines.SourceSetFolder
...
abstract class JacocoCustomConfig(
     ...
     */
    private var createdTaskInternal: TaskProvider<JacocoReport>? = null
     ...
     */
    private val createdTask: TaskProvider<JacocoReport> get() = createdTaskInternal!!
